        ...
        stories: {
            "/A.K.A._Dizzy/pos/lfJa5nhGOt": {
                ...
                contents:  `<section id="links">
                                <a class="link" target="_blank" href="/A.K.A._Dizzy/p/Jkik39djfX8iX"><span class="Title">snka</span><span class="linktype">Proyecto</span></a>
                            </section>`,
                Comentarios: ``
            },
            ...
            "/truck/pos/CMgd0lPQfl": {
                ...
                originalPoster: {
                    ...
                    profilePic: "/resources/images/truck/sdlQg1CoQ3_tn.jpg",
                    rol: {
                        rol: "Moderador",
                        level: "88"
                    },
            ...
            "/AuraCardonaC/pos/VJclElvkG9": {
                ...
                originalPoster: {
                    ...
                    profilePic: "/resources/images/AuraCardonaC/H5TxBHq4ff_tn.jpg",
                    rol: {
                    ...
                    rol: {
                     ...
                     tool: `<div class='tool'>
                                ...
                                <div class='datos'>
                                    ...
                                    <p class='rol'>G <b style='color:#fff;'>+65</b></p>
                                </div>
                              </div>`
                },
                title: "myProjext1",
            ...
            "/A.K.A._Dizzy/pos/CqRqjfsvAN": {
                type: "links",
                date: {
                    stt: "29,8,2021,17,07"
                },
                title: "Algunos Poemas Que He Escrito",
                description: ``,
                 contents: `<section id="links">
                                <a class="link" target="_blank" href="/A.K.A._Dizzy/blog/Algunos Poemas Que He Escrito"><span class="Title">Algunos Poemas Que He Escrito</span><span class="linktype">Blog</span></a>
                            </section>`,
                Comentarios: ""
            },
            "/A.K.A._Dizzy/pos/YpHMW4gHd4": {
                type: "containments",
                date: {
                    stt: "24,8,2021,16,30"
                },
                title: `La mujer que más amo en el mundo <a href="#<3">#<3</a> `,
                description: ``,
                 contents: `<section>
                                <div class="oculto">
                                    <a class="revelar">Mostrar la imagen oculta.</a>
                                    <section id="picture">
                                        <img class="pic" src="/resources/images/A.K.A._Dizzy/uc2B0X3uUH.jpg" alt="" class="big">
                                    </section>
                                    <section style="display: block; color: #aaa; " class="moreI" style="color: #aaa; ">
                                        Aaaww <br> <br>
                                        <3 <3 <3 <br> <br>
                                        Mentiras, Laura. Pero yo la quiero mucho, mucho. Perdóneme. E> E> <3 <3 </section>
                                </div>
                            </section>`,
                Comentarios: ""
            },
            ...
            "/A.K.A._Dizzy/pos/tYUH9yd1q6": {
                ...
                description: ``,
                 contents: `<section class="embed">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/oKsxPW6i3pM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </section>`,
                Comentarios: ""
            },
            "/A.K.A._Dizzy/pos/1dn2IQok9s": {
                type: "embed",
                date: {
                    stt: "8,6,2020,14,38"
                },
                title: "Greeicy - Los Besos",
                description: ``,
                 contents: `<section class="embed">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/rUi_KOmn7BM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </section>`,
                Comentarios: ""
            },
