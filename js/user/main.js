...
K100= function(builds){ 
    ...
    $(".foto").each(function(){ 
        ...
        (!hashes[w1] || (!!cold && (cold.hash)))? (function(){ 
            ...
            oReq.open("GET", "https://api.github.com/repos/liril-co/liril-co.github.io/commits?path=" +  w1 + ".html"); 
...
/*    function reqListener(){
    ...
    function k200(){ 
        ...
        if(typeof commitAF != "undefined"){
            ...
            oReq.open("GET", "https://raw.githubusercontent.com/liril-co/liril-co.github.io/" + commitAF);
            oReq.send();
        }
    } 
    ...
    oReq.open("GET", "https://api.github.com/repos/liril-co/liril-co.github.io/commits?path=" + window.location.pathname.slice(1, window.location.pathname.lastIndexOf(".html") != -1? window.location.pathname.lastIndexOf(".html"): window.location.pathname.length) + ".html");
    oReq.send();
*/
/*
k200= function(f, a){ 
...
$(".story").each(function(){ 
    ...
    oReq.open("GET", "https://raw.githubusercontent.com/liril-co/liril-co.github.io/" + cold.hash + w1 + ".html"); 
    oReq.send();
    })(): 1; 
});
*/
