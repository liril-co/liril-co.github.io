                      ...
                      <aside id="book">
                          <section id="content">
                              <section id="theater" class="theater animated fadeIn" style="display: block;">
                                  <section>
                                      <section id="picContainer">
                                          <img id="bigPic" alt="" src="/resources/images/${user.username}/${user.stories[_co].contents.image}">
                                          <div class="Playuse">
                                          </div>
                                          <video id="theater_video" controls class="video-js d88fer vjs-default-skin" preload="none" width="100%" height="264" data-setup='{}'  data-setup="{}">
                                              <source src="" type='video/mp4'/>
                                      ...
                                      <aside class="comments">
                                          <div class="info">
                                              ...
                                              <p class="username"><a class= "target" href= "/${user.username}/" title= "${user.tool}">${user.users_name}</a> <br><span title= "${fullDaTe(user.stories[_co].date.stt)}" class="time">${minDaTe(user.stories[_co].date.stt)}</span></p>
                                                                            ${typeof user.stories[_co].Editado !== "undefined"? `<span onmousedown= '${user.stories[_co].Editado[0]}' title='${user.stories[_co].Editado[1]}' class="Editado">Editado</span>`: ``}
                                          </div>
                                          <div class="description" style="padding-top: 76px;">
                                              <p class="title">${user.stories[_co].title}</p>
                                              <section class="more"></section>
                                          </div>
                                          <div class="comentarios">
                                             <div class="Comentarios">${user.stories[_co].Comentarios}</div>
                                             <div class="newComment">
                                                 <textarea rows="1"></textarea>
                                             </div>
                                          </div>
