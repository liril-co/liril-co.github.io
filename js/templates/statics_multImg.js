                      ...
                      <aside id="book">
                          ...
                          <section id="picContainer">
                              <section class="navigation">
                                <div class="nav_arrow left disabled"><div class="arrow"></div></div>
                                <div class="nav_arrow right"><div class="arrow"></div></div>
                                <section class= "carr">
                                    ${one("unTnCarrItem", foReach, user.fotos.fotos[_co].contents.carrContents)}
                                </section>
                              </section>
                              <div class="Playuse">
                              </div>
                          ...
                          <aside class="comments">
                              ...
                              <div class="description" style="padding-top: 76px;">
                                  <p class="title">${user.fotos.fotos[_co].title}</p>
                                  <section class="more"></section>
                              </div>
                              <div class="Comentarios">${user.fotos.fotos[_co].Comentarios}</div>
                              <div class="newComment">
                                  <textarea rows="1"></textarea>
                              </div>
                              <div class="options button">
