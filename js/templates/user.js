                                    ...
                                    <section class="hidden">
                                        <div class="info">
                                            ...
                                            <p class="username"><a href="/${user.username}" title= "${user.tool}">${user.users_name}</a>${typeof user.profilePic[Object.keys(user.profilePic)[0]].city !== "undefined"? `; en <a class="target" title="         
                                                ...
                                                <span title="${fullDaTe(user.profilePic[Object.keys(user.profilePic)[0]].date.stt)}" class="time">${minDaTe(user.profilePic[Object.keys(user.profilePic)[0]].date.stt)}</span>
                                            </p>
                                        </div>
