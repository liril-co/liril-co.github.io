...
var spliceThem= "kK4E9s28sJLci3dfwq219"
var firsTTime= "99Cjca9a9scja0c0cacpC"
var firsT= function(l, k, j, s){
	var reT= {}
	for(var f= 0; f < l; f++){
	...
	if(s == spliceThem){
	    finalObj={}
	    if($(".story").length >= 5){
		    for(var a= l; a < Object.keys(j).length; a++){
...
var _firsT= function(l, k, j, s){
	...
	if(s == spliceThem){
	    finalArr=[];
	    for(var a= l*2; a < j.length; a++){
	      	if(!!j[a])finalArr[a - l * 2]= j[a]
	    }
	    index.stories= finalArr
	}
	return reT
}
					...
					case "links":
						reTurn+=   `<section class="story links">
		                                <div class="info">
		                                    ...
		                                    <p class="username"><a class="target" href="/${user.username}/" title= "${user.tool}">${user.users_name}</a> <br><span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
					...
					case "informativeImg":
						reTurn+=   `<section class="story informative img">
		                                <div class="info">
		                                    <input class='knob button' data-width='47' data-height='47' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.12' readonly value='${user.rol.level}'>
		                                    <img src="/resources/assets/loading.gif" s_rc="/resources/images/${user.username}/${user.profilePic[Object.keys(user.profilePic)[0]].contents.image}" alt="">
		                                    <p class="username"><a class="target" href="/${user.username}/" title= "${user.tool}">${user.users_name}</a> ${c[e].information}<br><span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
		                                	${typeof c[e].Editado !== "undefined"? `<span onmousedown= '${c[e].Editado[0]}' title='${c[e].Editado[1]}' class="Editado">Editado</span>`: ``}
		                                </div>
		                                <p class="title">${c[e].title}</p>
		                                ${c[e].contents}
					...
					case "img":
						reTurn+=   `<section class="story img">
		                                <div class="info">
		                                    ...
		                                    <span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
		                                	${typeof c[e].Editado !== "undefined"? `<span onmousedown= '${c[e].Editado[0]}' title='${c[e].Editado[1]}' class="Editado">Editado</span>`: ``}
		                                </div>
		                                <p class="title">${c[e].title}</p>
					...
					case "links":
						reTurn+=   `<section class="story links">
		                                <div class="info">
		                                    ...
		                                    <p class="username"><a class="target" href="/${c[e].user.username}${c[e].user.username=="user"?"":"/"}" title= "${c[e].user.tool}">${c[e].user.users_name}</a> <br><span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
		                                	${typeof c[e].Editado !== "undefined"? `<span onmousedown= '${c[e].Editado[0]}' title='${c[e].Editado[1]}' class="Editado">Editado</span>`: ``}
		                                </div>
		                                <p class="title">${c[e].title}</p>
		                                ${c[e].contents}
					...
					case "informativeImg":
						reTurn+=   `<section class="story informative img">
		                                <div class="info">
		                                    <input class='knob button' data-width='47' data-height='47' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.12' readonly value='${c[e].user.rol.level}'>
		                                    <img src="/resources/assets/loading.gif" s_rc="/resources/images/${c[e].user.username}/${c[e].user.profilePic[Object.keys(c[e].user.profilePic)[0]].contents.image}" alt="">
		                                    <p class="username"><a class="target" href="/${c[e].user.username}${c[e].user.username=="user"?"":"/"}" title= "${c[e].user.tool}">${c[e].user.users_name}</a> ${c[e].information}<br><span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
		                                	${typeof c[e].Editado !== "undefined"? `<span onmousedown= '${c[e].Editado[0]}' title='${c[e].Editado[1]}' class="Editado">Editado</span>`: ``}
		                                </div>
		                                <p class="title">${c[e].title}</p>
		                                ${c[e].contents}
					...
					case "img":
						reTurn+=   `<section class="story img">
		                                <div class="info">
		                                    <input class='knob button' data-width='47' data-height='47' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.12' readonly value='${c[e].user.rol.level}'>
		                                    <img src="/resources/assets/loading.gif" s_rc="/resources/images/${c[e].user.username}/${c[e].user.profilePic[Object.keys(c[e].user.profilePic)[0]].contents.image}" alt="">
		                                    <p class="username"><a class="target" href="/${c[e].user.username}${c[e].user.username=="user"?"":"/"}" title= "${c[e].user.tool}">${c[e].user.users_name}</a>${typeof c[e].city !== "undefined"? `; en <a class="target" title="         
																																								               <div class='tool city'>
																																								                   <figure>
																																								                       <img class='thumbnail' src= '${c[e].city.pic}'></img>
																																								                   </figure>
					...
					case "repostLinks":
						reTurn+=   `<section class="story repost links">
		                                <div class="info">
		                                    ...
		                                    <input class='knob button' data-width='47' data-height='47' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.12' readonly value='${c[e].originalPoster.rol.level}'>
		                                    <img class="repost" src="/resources/assets/loading.gif" s_rc="${c[e].originalPoster.profilePic}" alt="">
		                                    <p class="username repost"><a class="target" href="/${c[e].user.username}${c[e].user.username=="user"?"":"/"}" title= "${c[e].user.tool}">${c[e].user.users_name}</a> Reposteó de <a class="target" href="/${c[e].originalPoster.username}${c[e].originalPoster.username=="user"?"":"/"}" title="${c[e].originalPoster.tool}">${c[e].originalPoster.users_name}</a><br>
		                                    <span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
		                                	${typeof c[e].Editado !== "undefined"? `<span onmousedown= '${c[e].Editado[0]}' title='${c[e].Editado[1]}' class="Editado">Editado</span>`: ``}
		                                </div>
		                                <p class="title">${c[e].title}</p>
					...
					case "fork":
						reTurn+=   `<section class="story fork links">
		                                <div class="info">
		                                    ...
		                                    <input class='knob button' data-width='47' data-height='47' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.12' readonly value='${c[e].originalRepoOwner.rol.level}'>
		                                    <img class="fork" src="/resources/assets/loading.gif" s_rc="${c[e].originalRepoOwner.profilePic}" alt="">
		                                    <p class="username fork"><a class="target" href="/${c[e].user.username}${c[e].user.username=="user"?"":"/"}" title= "${c[e].user.tool}">${c[e].user.users_name}</a> Forkeó de <a class="target" href="/${c[e].originalRepoOwner.username}${c[e].originalRepoOwner.username=="user"?"":"/"}" title="${c[e].originalRepoOwner.tool}">${c[e].originalRepoOwner.users_name}</a><br>
		                                    <span title="${fullDaTe(c[e].date.stt)}" class="time">${minDaTe(c[e].date.stt)}</span></p>
		                                	${typeof c[e].Editado !== "undefined"? `<span onmousedown= '${c[e].Editado[0]}' title='${c[e].Editado[1]}' class="Editado">Editado</span>`: ``}
		                                </div>
		                                <p class="title">${c[e].title}</p>
...
minDaTe= function(c){
	...
	let mDate=c.split(",");
	let meR=parseInt(mDate[3])>12?"pm":"am"
	let houR=parseInt(mDate[3])-(parseInt(mDate[3])>12?12:0)
	let l=houR==1?"la":"las";
	
	if(mDate[2]==yeaR){
		return `${mDate[0]} de ${months[mDate[1]-1]} a ${l} ${houR}:${mDate[4]} ${meR}`
	}else{
		return `${months[mDate[1]-1]} de ${mDate[2]}`
	}
}
fullDaTe= function(c){
	let date=new Date();
	...
	return `${mDate[0]} de ${months[mDate[1]-1]} de ${mDate[2]} a ${l} ${houR}:${mDate[4]} ${meR}`
}
...
badGuy= function(){ 
	if(RooT.maTch.root.exec(actualLocation) !== null){
		...
		/*impR(check this un_tn() if not counteractei)*/
...
k300= function(C, p, y, ty, rep){ 
    ...
    if(!!JSON.parse(localStorage.getItem(`/${rep}${C.target.responseURL.slice(C.target.responseURL.lastIndexOf("=") + 1, C.target.responseURL.lastIndexOf("."))}`)) && JSON.parse(localStorage.getItem(`/${rep}${C.target.responseURL.slice(C.target.responseURL.lastIndexOf("=") + 1, C.target.responseURL.lastIndexOf("."))}`)).hash != JSON.parse(C.target.response)[0].sha){
        ...
        oReq.open("GET", `https://raw.githubusercontent.com/liril-co/${rep}/${JSON.parse(localStorage.getItem(`/${rep}${C.target.responseURL.slice(C.target.responseURL.lastIndexOf("=") + 1, C.target.responseURL.lastIndexOf("."))}`)).hash + C.target.responseURL.slice(C.target.responseURL.lastIndexOf("=") + 1, C.target.responseURL.lastIndexOf("."))}.html`); 
        oReq.send(); 
    }else{
        switch(ty){
        	case "foto": 
    ...
    nonBuilt= (function(){ 
    	...
    	_R(".foto").each(function(){ 
	        ...
	        (!hashes[w1] || (!!cold && (cold.hash)))? (function(){ 
	            ...
	            oReq.open("GET", `https://api.github.com/repos/liril-co/${user.username}/commits?path=${trimUsername(w1)}.html`); 
	    ...
	    _R(".story").each(function(){ 
	        ...
	        ((typeof hashes[w1] == "undefined" || (!!cold && (cold.hash))) && ["user", ""].indexOf(typeof userRe != "undefined"?userRe:typeof op != "undefined"?op:user.username) == -1)? (function(){ 
	            ...
	            oReq.open("GET", `https://api.github.com/repos/liril-co/${typeof userRe != "undefined"?userRe:typeof op != "undefined"?op:user.username}/commits?path=${trimUsername(w1)}.html`); 
	            oReq.setRequestHeader('Authorization', "token " + token); 
	            oReq.send(); 
	            a= t; 
...
K0= function(){
    ...
    oReq.open("GET", "https://api.github.com/repos/liril-co/liril-co.github.io/pages/builds"); 
    oReq.setRequestHeader('Authorization', "token " + token); 
    oReq.send();
}
...
<span class="resulttype">Proyecto</span>
		...
		if(r.shiftKey && r.ctrlKey && r.altKey){r.preventDefault();_R("#theater", und, 'e').css("display") == "block"?closeModal():1;_R("#buscar input", und, 'e').val("");_R("#buscar input", und, 'e').trigger("input");_R("#buscar input", und, 'e').focus()}
...
if(RooT.maTch.user.exec(window.location.pathname) !== null){
	firsT(5, _of, user.stories, spliceThem)
    ...
    while(Used.length != Urls.length){ 
        ...
        if(_R("#resizeBottom ul").length)_R("#resizeBottom ul")[0].innerHTML= `${_R("#resizeBottom ul")[0].innerHTML}<li class="button offline"><img src= "/resources/assets/loading.gif" s_rc="/resources/images/chat/${Urls[randmIntgr]}" alt=""><p>${Urls[randmIntgr].slice(0, Urls[randmIntgr].indexOf("."))}</p><span ></span></li>`
...
_R('a[href="/truck/"]').on("click", function(e){
	e.preventDefault()
	history.pushState({page: 1}, "", `/truck/`)
  RooT.imporT("/js/truck/DB.js", Then, function(d){
    _R(".ui-tooltip").remove()
    window.user= d._user()
    RooT.imporT("/js/templates/user.js", Then, function(d){
      _T(document).scrollTop(0)
...
_R(".Editado").e()
	...
	}else if(RooT.maTch.imgStatic.exec(window.location.pathname) !== null || RooT.maTch.vidStatic.exec(window.location.pathname) !== null){
		actualLocation= window.location.pathname
		//
    	Used= []; 
	    Urls= ["Abigail O'Neill.jpg", "Alana Campos.png", "Alexandra Tyler.jpeg", "Ali Chanel.jpg", "Ali Michael.jpg", "Alicia Loraina Olivas.jpg", "Allie Leggett.jpg", "Allie Silva.jpg", "Alyssa Arcè.jpg", "Amanda Booth.jpg", "Amanda Cerny.webp", "Amanda Streich.jpg", "Amberleigh West.jpg", "Amelia Talon.jpg", "Amy Leigh Andrews.jpg", "Ana Cheri.webp", "Anita Pathammavong.jpg", "Anna Sophia Berglund.jpg", "Ashley Doris.jpg", "